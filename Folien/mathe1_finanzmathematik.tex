...
\begin{frame}{Beispiel Zinseszins}
 	\begin{example}
		...
		\[
		K_{5} = K_{0} \left(1 + 0.06 \right)^5 = 4000 \text{€} \cdot \left( 1.06 \right)^5 = 5352.90 \text{€}
		\]
	\end{example}
	\begin{bemerkung}
...
\begin{frame}{Gemischte Verzinsung}
	...
	\small{\begin{example}
		...
		\[
		K_{\text{16. März 2019}} = 10000 \cdot \left( 1+0.12\cdot\frac{135}{360}  \right) \cdot \left( 1+0.12 \right)^{3} \cdot \left( 1+0.12\cdot\frac{76}{360} \right) \approx 15053.43
		\]
	\end{example}}
\end{frame}
