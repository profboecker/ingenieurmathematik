...
\begin{frame}{Reelle Zahlen haben ein(!) Problem}
	...
	Wir werden im Folgenden eine Zahlenmenge konstruieren, die auch Lösungen der Gleichung $x^{2}+1=0$ und alle reellen Zahlen enthält.
\end{frame}
...
\begin{frame}{Rechnen mit komplexen Zahlen}
	...
	\begin{itemize}
		...
		\item Die reelle Zahl $|z| := \sqrt{z\cdot \overline{z}} = \sqrt{a^{2} + b^{2}}$ heißt der \textbf{Betrag} oder die \textbf{Länge} von $z=a+bj$.
